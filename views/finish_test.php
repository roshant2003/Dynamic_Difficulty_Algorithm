...
<body>
    ...
    <div class="bg">
        ...
        <nav class="navbar navbar-default title1">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="views/account.php?q=1"><b>Dashboard - Student</b></a>
                </div>
        ...
        <div class="container">
            <center><h1>Test Finished!</h1>
            <h4>Final Score: <?php echo $totalResult; ?></h4>
            <h4>Average Difficulty: <?php echo $averageDifficulty; ?></h4></center>
        </div>
